  ...
  return html`
    <footer class="text-center mt-auto pb-xl">
      <div class="flex justify-center gap-x-md mb-md">
        <a href="${githubUrl}" target="_blank" class="text-sm text-secondary">${githubIconTmpl(35, 35, 'fill-secondary')}</a>
        <a href="${linkedinUrl}" target="_blank" class="text-sm text-secondary">${linkedinIconTmpl(35, 35, 'fill-secondary')}</a>
      </div>
